...
public class HttpRequestUtils {
    ...
    public static String doGet(String url, Map<String, Object> params, Map<String, String> headers) {
        ...
        apiUrl += param;
        String result = null;
        HttpApiLogger.beforeInvoke(url, "GET", params, headers);
    ...
    public static String doPost(String apiUrl, Map<String, Object> params, Map<String, String> headers) {
        ...
        try {
            HttpApiLogger.beforeInvoke(apiUrl, "POST", params, headers);
            StopWatch watch = new StopWatch();
            watch.start();
    ...
    public static String doPost(String apiUrl, JSONObject json, Map<String, String> headers) {
        ...
        CloseableHttpResponse response = null;
        try {
            HttpApiLogger.beforeInvoke(apiUrl, "POST", json, headers);
            StopWatch watch = new StopWatch();
            watch.start();
            for (Map.Entry<String, String> entry : headers.entrySet()) {
                httpPost.addHeader(entry.getKey(), entry.getValue());
    ...
    public static String doPostSSL(String apiUrl, JSONObject json, Map<String, String> headers) {
        ...
        try {
            HttpApiLogger.beforeInvoke(apiUrl, "POST-SSL", json, headers);
            StopWatch watch = new StopWatch();
            watch.start();
            for (Map.Entry<String, String> entry : headers.entrySet()) {
                httpPost.addHeader(entry.getKey(), entry.getValue());
...
//				httpPost.addHeader(entry.getKey(), entry.getValue());
//			}
            HttpApiLogger.beforeInvoke(apiUrl, "POST", jsonStr);
            StopWatch watch = new StopWatch();
            watch.start();
            httpPost.setConfig(requestConfig);
